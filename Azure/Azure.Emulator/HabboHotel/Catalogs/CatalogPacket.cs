...
namespace Azure.HabboHotel.Catalogs
{
    ...
    /// Class CatalogPacket.
    /// </summary>
    internal static class CatalogPacket
    {
        /// <summary>
        /// Composes the index.
        /// </summary>
                                                 ...
                                                 int limitedSelled = 0)
        {
            ...
            message.AppendBool(false); //isRentable
            message.AppendInteger(creditsCost);
            message.AppendInteger(diamondsCost);
            message.AppendInteger(activityPointsCost);
            message.AppendBool(true); //isGiftVisible
            message.AppendInteger(items == null ? 0 : items.Count);
