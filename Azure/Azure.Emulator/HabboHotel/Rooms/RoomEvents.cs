        ...
        {
            {
                ...
                {
                    queryreactor2.SetQuery(string.Concat("REPLACE INTO rooms_events VALUES (", roomId, ", @name, @desc, ", Azure.GetUnixTimeStamp() + 7200, ", @category)"));
                ...
                _events.Add(roomId, new RoomEvent(roomId, eventName, eventDesc, 0));
            IL_17C:
