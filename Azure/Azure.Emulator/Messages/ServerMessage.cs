...
namespace Azure.Messages
{
    ...
    internal class ServerMessage : IDisposable
    {
        ...
        {
            Encoding encoding = isUtf8 ? Encoding.UTF8 : Azure.GetDefaultEncoding();
        ...
        public byte[] GetReversedBytes()
        {
            ...
            if (Azure.DebugMode)
            {
                ...
                Console.Write(Id + Environment.NewLine + HabboEncoding.GetCharFilter(Azure.GetDefaultEncoding().GetString(bytes)));
                Console.WriteLine();
            }
